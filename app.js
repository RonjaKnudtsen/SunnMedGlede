...
angular.module('sunn_sterk.slider', ['ngAnimate']);

var app = angular.module('sunn_sterk', ['ui.router', 'sunn_sterk.controllers', 'sunn_sterk.services','sunn_sterk.session', 'sunn_sterk.slider', 'sunn_sterk.directive','ngSanitize' ]);
/*
Hjem - Home 
